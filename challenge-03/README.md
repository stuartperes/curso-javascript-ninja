...
*/
var pessoa = {nome: 'Stuart', sobrenome: 'Pericles', sexo: 'masculino', idade: 27, altura: 1.88, peso: 90, andando: false, caminhouQuantosMetros: 0}
...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome completo é Stuart Pericles'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura(); // 'Minha altura é 1.88m'
